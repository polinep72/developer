...
def finalize_booking(call):
    ...
    insert_query = """
        INSERT INTO bookings (user_id, equip_id, date, time_start, time_end, time_interval, duration, cancel, extension, finish)
        VALUES (%s, %s, %s, %s, %s, %s, %s, FALSE, NULL, NULL)
    """
    execute_query1(insert_query, (user_id, equipment_id, selected_date, start_datetime, end_datetime, time_interval, duration))
