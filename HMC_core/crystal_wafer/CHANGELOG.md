...
- Все склады теперь имеют одинаковые поля поиска: производитель, партия, шифр кристалла

### Added
- Добавлен фильтр по партии для складов "Склад пластин" и "Дальний склад"
- Расширен API `/api/get_lots` для работы со всеми типами складов
- Динамическая загрузка партий при изменении производителя работает для всех складов

### Removed
- Удален фильтр по пластине на складах "Склад пластин" и "Дальний склад" для унификации интерфейса
