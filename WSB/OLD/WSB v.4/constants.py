...
# Версия программы
APP_VERSION = "WSB v.4.0.0" # Пример с патчем
"""
...
ADMIN_STATE_ADD_EQUIP_NEW_CAT_NAME = "admin_add_equip_new_cat_name"
ADMIN_STATE_ADD_EQUIP_NAME = "admin_add_equip_name"
ADMIN_STATE_ADD_EQUIP_NOTE = "admin_add_equip_note"
...
MSG_HELP_USER = (
    ...
    "`/help` - Помощь\n"
    f"_Версия: {APP_VERSION}_" # Добавляем курсивом в конце
)
