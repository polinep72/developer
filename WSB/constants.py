"""
Прокси для констант: реэкспорт из `wsb_bot.constants`.
Оставлен для обратной совместимости импортов из корня.
"""

from wsb_bot.constants import *  # noqa: F401,F403 – сознательный реэкспорт
