...
Веб-приложение и телеграм-бот работают в одном процессе Flask внутри единого Docker-контейнера.
См. подробные инструкции в `DOCKER_SETUP.md` и `DEPLOYMENT.md`.
...
Новые функции, доработки и планы развития в рамках данного репозитория не предусматриваются.
