...
## Версия
**Текущая версия: 1.4.24** (обновлено: 2025-12-17)
...
## Последние изменения (v1.4.24)

- Исправлена логика инвентаризации для корректной обработки нулевых остатков (v1.4.24)
- Исправлено применение фильтров в SQL запросах инвентаризации (v1.4.24)
- Улучшено отображение сообщения "Нулевые остатки" с правильным размером шрифта (v1.4.24)
- Кнопки экспорта доступны даже при нулевых остатках (v1.4.24)
...
- **Статус развития:** Развитие проекта заморожено на версии **1.4.24** (дата заморозки: 2025-12-18)
