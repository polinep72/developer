...
## Последние изменения (v1.3.5)
- Поиск и корзина теперь доступны без авторизации для неавторизованных пользователей
- Реализована система временных идентификаторов для неавторизованных пользователей
- Добавлена система управления пользователями для администраторов (v1.3.4)
- Унифицирован интерфейс поиска для всех типов складов
- Добавлена поддержка нескольких типов складов (Склад кристаллов, Склад пластин, Дальний склад)
